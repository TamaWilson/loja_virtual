...
class OrderTile extends StatelessWidget {
  ...
  Widget _buildCircle(String phase, String subtitle, int status, int thisStatus) {
    ...
    if(status < thisStatus){
      ...
      child = Text(phase, style: TextStyle(color: Colors.white),);
    } else if(status == thisStatus) {
      backColor = Colors.blue;
      child = Stack(
        alignment: Alignment.center,
        children: <Widget>[
          Text(phase, style: TextStyle(color: Colors.white),),
